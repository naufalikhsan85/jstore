...
public class DatabaseInvoice
{
    ...
    public static Invoice getActiveOrder(Customer customer)
    {
        ...
        for(Invoice invoice : INVOICE_DATABASE)
        {
            if(invoice.getInvoiceType()==InvoiceType.Sell&&(invoice.getInvoiceStatus()==InvoiceStatus.Installment||invoice.getInvoiceStatus()==InvoiceStatus.Paid)&&invoice.getIsActive()==true)
            {
                value=invoice;
            }
